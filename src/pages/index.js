                ...
                <ul className="features">
                  <li>
                    ...
                    <p>
                      ...
                      technology, lower royalty and service fees, vendor
                      selections, and other services are all designed to
                      substantially drive down the costs for agents to pursue
                      their careers.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      Our Agent Fee Structure is as simple as you can get. We
                      offer two models: a monthly flat rate fee, or a gross
                      commission income fee, with the ability to change plans
                      every six months. In either case, there are no surprises.
                      And never any desk, office, E&O, or any other fees.
                      Period.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      trainings and education sessions are accessible both
                      in-office and remotely. In addition there are online
                      training videos, webinars and publications to improve your
                      abilities and increase your income. And for brand new
                      agents, we offer a mentoring program to develop the
                      knowledge and confidence before you go off on your own.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <h3>NO FLOOR TIME</h3>
                    <p>
                      Aside from referrals, in many cases, buyers and sellers
                      find their prospective agents online. That is where you
                      should be to greet them. Our programs assure agents a
                      strong social media presence to ensure they are found.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      ...
                      Transact, market, and execute your business anywhere,
                      anytime. And to make it even easier, our technology,
                      advertising, marketing and training are all integrated …
                      and part of the package. Experience a comprehensive
                      platform and full set of easy–to-use services all in one
                      place.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      We are stronger together. Be a market and prospecting
                      expert by sharing ideas, trying new practices and staying
                      current for a thriving business tomorrow.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      ...
                      provide, including our website, the Featured Listings
                      program, Mobile Connect, Reach150, real estate property
                      website profiles, social media, and local marketing
                      tailored to Orange County. We are about providing quality
                      leads, not quantity or time-consuming leads.
                    </p>
                  </li>
                </ul>
